...
10. Unlock Casino Heist by finding a rare Getaway Car in the maze or buying one from a shop for exactly `$100`, then flee the robbed casino down a smooth six-lane road that turns, widens, narrows, and splits around medians — shooting your way through slower traffic, ramming police, and spike-dropping helicopters — and drop into a marked storm drain for a `$1000` payout.
...
- Casino Heist: first acquire the Getaway Car as rare maze loot or buy it for exactly `$100`. You have just robbed the casino and the road runs away from it. Steer with arrows/A/D and drive **up or down** the road with Up/Down to close on traffic or hang back from it. The road is a smooth six-lane ribbon that sweeps through real turns, widens and narrows, and every so often divides around a median you may pass either side of. Ordinary cars, buses, trucks, and motorcycles are all slower than you, and **you can shoot any of them** — a car or bike goes down to one hit, a truck or bus takes two. Nothing you wreck stays in the way: it slews off the road, spinning and smoking, and clears. Cop cars and SWAT vans ram you toward the verge and shoot from a rolled-down window — and they cannot drive through traffic either, so they wreck themselves on it. Police helicopters hold station ahead and drop a partial-width spike strip unless you shoot them down. The car starts unarmed: collect the pulse gun, ammunition, and the oil-slick, smoke-screen, and flamethrower devices on the road, or buy them as permanent car modules at a maze shop. `Q`/Deploy spends the armed device, `E`/Switch arms the next one. Reach the marked turn-off and drop into the storm drain to vanish with `$1000`; drive past it and the road runs out.
